  ...
  return (
    <div className="w-full animate-fade-in">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-900 tracking-tight">Create Template</h1>
          <p className="text-xs text-slate-600">Design custom fields for your trade logs</p>
        </div>
      </div>
          ...
          <div className="xl:w-[340px] flex-shrink-0 space-y-4">
                ...
                {FIELD_TYPES.map(ft => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 p-3 rounded-xl border border-slate-300 hover:border-${ft.color}/40 hover:bg-${ft.color}/5 transition-all group`}
                    >
            ...
            <div className="flex items-start gap-2 p-3 rounded-xl bg-green-primary/5 border border-green-primary/10">
              ...
              <div className="text-[10px] text-slate-600 space-y-1">
                <p>• All template fields are <strong className="text-slate-900">optional</strong> when logging trades</p>
          ...
          <div className="flex-1 min-w-0">
            <div className="card min-h-[400px]">
              <div className="flex items-center justify-between mb-4">
                ...
                {fields.length > 0 && (
                  <span className="text-[10px] text-slate-600">Drag or use arrows to reorder</span>
                )}
              </div>
              ...
              {fields.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="text-sm text-slate-600 mb-1">No fields added yet</p>
                  <p className="text-xs text-slate-600/60">Click a field type on the left to add it</p>
                </div>
              ) : (
